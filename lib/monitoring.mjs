...
<body><main>
  ...
  <section class="note"><strong>Lectura del informe.</strong> La disponibilidad proviene del historial agregado de Gatus. Una falla técnica se comunica como incidente sólo después de validarla. Guardián PyME autorrecupera sus propios componentes; sobre sistemas del cliente sólo ejecuta acciones previamente autorizadas. Cualquier otro cambio requiere aprobación. Este informe no garantiza disponibilidad permanente ni ausencia de incidentes.</section>
...
Estamos verificando el alcance y la causa. Te avisaremos cuando confirmemos la recuperación o tengamos una acción recomendada. Si hace falta un cambio no preautorizado, te pediremos aprobación antes de ejecutarlo.
